  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 flex justify-between items-start">
        <div>
          <h1 className="display-md text-accent-cream mb-2">Book an Appointment</h1>
      ...
      {step === 1 && (
        <div>
          <h2 className="heading-main text-accent-cream mb-6">Select a Service</h2>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mb-12">
                <h3 className="heading-section text-accent-cream mb-6">Package Services</h3>
                {services.filter(s => !s.is_solo).length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-accent-cream text-lg">No package services available.</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {services.filter(s => !s.is_solo).map((service) => (
                      ...
                      >
                            ...
                            <ul className="text-xs text-accent-cream space-y-1">
                              {service.inclusions.slice(0, 2).map((inclusion, index) => (
                                <li key={index} className="flex items-center gap-2">
                                  <FaCheck className="text-secondary-light" size={10} />
                        ...
                        <button className="mt-3 w-full bg-secondary text-accent-cream py-2 rounded-lg hover:bg-secondary-light transition-colors font-semibold text-sm">
                          Select Service
                        </button>
                      </div>
                    ))}
              ...
              <div className="mt-12 pt-8 border-t-2 border-brand-gold">
                <h3 className="heading-section text-brand-gold mb-6">Add-ons & Solo Services</h3>
                {services.filter(s => s.is_solo).length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-accent-cream text-lg">No add-ons or solo services available.</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {services.filter(s => s.is_solo).map((service) => (
                      <div
                        key={service.id}
                        onClick={() => handleServiceSelect(service)}
                        className="bg-primary-dark rounded-lg shadow-md p-4 cursor-pointer hover:shadow-xl transition-shadow border-2 border-brand-gold hover:border-accent-peach"
                      >
                        ...
                        <button className="w-full bg-brand-gold text-primary-darker py-1.5 px-2 rounded-lg hover:bg-accent-peach transition-colors font-semibold text-xs">
                          Select
                        </button>
                      </div>
                    ))}
      ...
      {step === 2 && selectedService && (
        <div>
          ...
          <h2 className="heading-main text-accent-cream mb-2">Select Date & Time</h2>
          <p className="text-accent-cream mb-2">Service: <span className="font-semibold">{selectedService.service_name}</span> ({formatDuration(selectedService.duration_minutes)})</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-2 border-gray-300">
              ...
              <select
                ...
                className="w-full px-4 py-2 border-2 border-gray-300 bg-white text-gray-900 rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary"
              >
            ...
            <div className="bg-white rounded-lg shadow-md p-6 lg:col-span-2 border-2 border-gray-300">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  {availableSlots.map((slot, index) => (
                    <button
                      ...
                      className="px-4 py-3 border-2 border-gray-300 rounded-lg hover:bg-gray-100 hover:border-secondary transition-colors text-sm text-gray-900 font-semibold"
                    >
      ...
      {step === 3 && selectedService && selectedTimeSlot && (
        <div>
          ...
          <h2 className="heading-main text-accent-cream mb-6">Confirm Appointment</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6 border-2 border-gray-300">
            ...
            {selectedPet && (
              <div className="mt-6 pt-6 border-t-2 border-gray-300">
                ...
                <div className="border-2 border-secondary rounded-lg p-4 bg-blue-50">
                  <div className="flex items-center gap-4">
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                rows="4"
                className="w-full px-4 py-2 border-2 border-gray-300 bg-white text-gray-900 rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary resize-none"
          ...
          <div className="bg-primary-dark rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border-2 border-brand-gold" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-brand-gold p-6 text-primary-darker border-b-2 border-brand-gold sticky top-0">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="heading-main text-primary-darker">Add Optional Add-ons</h2>
                  <p className="text-sm text-primary-darker font-medium">Base Service: {selectedService.service_name}</p>
                </div>
                <button
            ...
            <div className="p-6 bg-primary-darker space-y-6">
              ...
              {selectedAddOns.length > 0 && (
                <div className="bg-primary rounded-lg p-4 border-2 border-brand-gold">
            ...
            {/* Modal Footer */}
            <div className="bg-primary-dark border-t-2 border-brand-gold p-6 flex gap-3">
              <button
                onClick={() => setShowAddOnsModal(false)}
                className="flex-1 bg-primary text-accent-cream py-2 px-4 rounded-lg hover:bg-primary-dark transition-colors font-semibold"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 bg-brand-gold text-primary-darker py-2 px-4 rounded-lg hover:bg-accent-peach transition-colors font-semibold"
              >
