"""
Django settings for chonkyweb_backend project.
...
SECRET_KEY = 'django-insecure-++j^74_&$8e$h(3d7lt#wh%xm%cumek2$wwd^llog5selbteez'
...
ROOT_URLCONF = 'chonkyweb_backend.urls'
